...
<div>
    {/* <div className="preload preload-container">
        <div className="preload-logo" style="background-image: url('images/logo/144.png')">
            <div className="spinner"></div>
        </div>
    </div> */}
    <div className="header fixed-top bg-surface">
        <a onClick={navigate(()=>'/userinfo')} className="left back-btn"><i className="icon-left-btn"></i></a>
        <a onClick={navigate(()=>'/')} className="right"><i className="icon-home2 fs-20"></i></a>
    </div>
    <div className="pt-45 pb-16">
        <div className="tf-container">
            <h4>Profile</h4>
            <a href="verification.html" className="mt-16 d-flex justify-content-between align-items-center">
            ...
            <ul className="mt-16 pb-12 line-bt">
                ...
                <li>
                    <a href="javascript:void(0);" className="mt-16 d-flex justify-content-between align-items-center">
                        ...
                        <span className="text-secondary d-flex gap-8 align-items-center">4563783947492974739282 <i className="icon-copy fs-16 text-secondary"></i></span>
                    </a>
                </li>
                <li>
            ...
            <ul className="mt-16 pb-16 line-bt">
                ...
                <li>
                    <a href="option.html" className="mt-16 d-flex justify-content-between align-items-center">
                        <p className="text-small">Option</p>
                        <span className="icon-arr-right text-secondary fs-12"></span>
                    </a>
                </li>
                <li>
                    <a href="security-center.html" className="mt-16 d-flex justify-content-between align-items-center">
            ...
            <span className="text-button mt-32 d-inline-block text-red fw-6" data-bs-toggle="modal" data-bs-target="#logout">
                Log out
            </span>
        </div>
    </div>
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content modal-sm">
                ...
                <div className="grid-2">
                   <a  className="line-r text-center text-button fw-6 p-10" data-bs-dismiss="modal">Cancel</a>
                   <a className="text-center text-button fw-6 p-10 text-red" onClick={logout}>Log Out</a>
                </div>
